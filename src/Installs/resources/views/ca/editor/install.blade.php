...
<div class="box">
	...
	<div class="box-body">
		<p>Module Admin Code Editor does not comes inbuilt now. You can get it by following commands.</p>
		...
		<p>Now refresh this page or go to <a href="{{ url(config('moduleadmin.adminRoute') . '/laeditor') }}">{{ url(config('moduleadmin.adminRoute') . '/laeditor') }}</a>.</p>
	</div>
</div>
