		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				@if(CAConfigs::getByKey('show_messages'))
				...
				@endif
				@if(CAConfigs::getByKey('show_notifications'))
				<!-- Notifications Menu -->
				...
				@endif
				@if(CAConfigs::getByKey('show_tasks'))
				<!-- Tasks Menu -->
						...
						<ul class="dropdown-menu">
							...
							<li class="user-body">
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('moduleadmin.adminRoute') . '/lacodeeditor') }}"><i class="fa fa-code"></i> <span>Editor</span></a>
								</div>
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('moduleadmin.adminRoute') . '/modules') }}"><i class="fa fa-cubes"></i> <span>Modules</span></a>
								</div>
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('moduleadmin.adminRoute') . '/la_menus') }}"><i class="fa fa-bars"></i> <span>Menus</span></a>
								</div>
								<div class="col-xs-6 text-center mb10">
									<a href="{{ url(config('moduleadmin.adminRoute') . '/la_configs') }}"><i class="fa fa-cogs"></i> <span>Configure</span></a>
								</div>
								<div class="col-xs-6 text-center">
									<a href="{{ url(config('moduleadmin.adminRoute') . '/backups') }}"><i class="fa fa-hdd-o"></i> <span>Backups</span></a>
								</div>
							</li>
							@endrole
							<!-- Menu Footer-->
							<li class="user-footer">
								<div class="pull-left">
									<a href="{{ url(config('moduleadmin.adminRoute') . '/users/') .'/'. Auth::user()->id }}" class="btn btn-default btn-flat">Profile</a>
								</div>
