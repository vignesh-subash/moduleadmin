<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif{{ CAConfigs::getByKey('sitename') }}</title>
    ...
    -->
    <link href="{{ asset('la-assets/css/skins/'.CAConfigs::getByKey('skin').'.css') }}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
