...
<div id="page-content" class="profile2">
	<div class="bg-success clearfix">
		...
		<div class="col-md-1 actions">
			@ca_access("Employees", "edit")
				<a href="{{ url(config('moduleadmin.adminRoute') . '/employees/'.$employee->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endca_access

			@ca_access("Employees", "delete")
				{{ Form::open(['route' => [config('moduleadmin.adminRoute') . '.employees.destroy', $employee->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('moduleadmin.adminRoute') . '/employees') }}" data-toggle="tooltip" data-placement="right" title="Back to Employees"><i class="fa fa-chevron-left"></i></a></li>
	...
	<div class="tab-content">
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@ca_display($module, 'name')
						@ca_display($module, 'designation')
						@ca_display($module, 'gender')
						@ca_display($module, 'mobile')
						@ca_display($module, 'mobile2')
						@ca_display($module, 'email')
						@ca_display($module, 'dept')
						@ca_display($module, 'city')
						@ca_display($module, 'address')
						@ca_display($module, 'about')
						@ca_display($module, 'date_birth')
						@ca_display($module, 'date_hire')
						@ca_display($module, 'date_left')
						@ca_display($module, 'salary_cur')
					</div>
				</div>
			</div>
		</div>
		...
		<div role="tabpanel" class="tab-pane fade" id="tab-account-settings">
			<div class="tab-content">
				<form action="{{ url(config('moduleadmin.adminRoute') . '/change_password/'.$employee->id) }}" id="password-reset-form" class="general-form dashed-row white" method="post" accept-charset="utf-8">
					{{ csrf_field() }}
					<div class="panel">
						<div class="panel-default panel-heading">
