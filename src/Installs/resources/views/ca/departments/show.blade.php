...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@ca_access("Departments", "edit")
				<a href="{{ url(config('moduleadmin.adminRoute') . '/departments/'.$department->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endca_access

			@ca_access("Departments", "delete")
				{{ Form::open(['route' => [config('moduleadmin.adminRoute') . '.departments.destroy', $department->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('moduleadmin.adminRoute') . '/departments') }}" data-toggle="tooltip" data-placement="right" title="Back to Departments"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@ca_display($module, 'tags')
						@ca_display($module, 'color')
					</div>
				</div>
			</div>
		</div>
