...
class ModuleController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		return redirect()->route(config('moduleadmin.adminRoute') . '.modules.show', [$module_id]);
	}
	...
	public function destroy($id)
	{
		...
		$modules = Module::all();
		return redirect()->route(config('moduleadmin.adminRoute') . '.modules.index', ['modules' => $modules]);
	}
...
/**
	...
	public function save_role_module_permissions(Request $request, $id)
	{
        ...
        return redirect(config('moduleadmin.adminRoute') . '/modules/'.$id."#access");
	}
